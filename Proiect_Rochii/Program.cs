...
builder.Services.AddDbContext<Proiect_RochiiContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("Proiect_RochiiContext") ?? throw new InvalidOperationException("Connection string 'Proiect_RochiiContext' not found.")));
